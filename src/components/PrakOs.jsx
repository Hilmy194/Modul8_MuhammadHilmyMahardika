...
import logo from "../assets/OSLogo.svg";

export default function PrakOS() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-sans">
      ...
      <section className="flex flex-col items-center text-center p-8">
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg w-96">
          <img src={logo} alt="OS Logo" className="w-32 h-32 mx-auto mb-4" />
          <h2 className="text-3xl font-bold text-white mb-2">Praktikum Sistem Operasi</h2>
          <p className="text-gray-300 text-lg leading-relaxed">
            Praktikum ini mempelajari konsep dasar sistem operasi, manajemen proses,
